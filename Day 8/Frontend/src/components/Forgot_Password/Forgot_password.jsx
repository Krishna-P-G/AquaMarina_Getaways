...
function Forgot_password() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:8080/updateUser/${email}/${password}`);
  ...
  return (
    <div className="w-full h-screen flex items-start">
      ...
      <div className="relative w-1/2 h-full flex flex-col">
        <img
          src="https://plus.unsplash.com/premium_photo-1674854858273-6fa2c7ea925c?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="cover_image"
